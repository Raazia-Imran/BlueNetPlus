...
export default function CoralForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase
        .from("coral_memberships") // Must match table name exactly
        .insert([formData]);
      ...
      toast({
        ...
        description:
          "Thank you for your interest. Our corporate team will contact you.",
      });
      navigate("/membership");
    } catch (error: any) {
  ...
  return (
    <div className="py-12 px-4 max-w-2xl mx-auto min-h-screen">
      <Button
        variant="ghost"
      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-100">
        <div className="flex items-center gap-3 mb-6">
          <div className="p-3 bg-[#FF7F50] bg-opacity-20 rounded-full text-[#FF7F50]">
            <Building2 size={24} />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label className="text-sm font-medium">Focal Person Name</label>
              <input
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="Technology">Ocean Technology</option>
          ...
          <Button
            type="submit"
            className="w-full bg-[#FF7F50] hover:bg-[#E06040] text-white mt-4"
            disabled={loading}
          >
