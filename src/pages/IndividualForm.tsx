...
export default function IndividualForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error } = await supabase
        .from("individual_memberships") // Must match table name exactly
        .insert([formData]);
      ...
      toast({
        ...
        description:
          "Welcome to the hub. We will review your application shortly.",
      });

      // 3. Redirect back to home or membership page
      navigate("/membership");
    } catch (error: any) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="e.g. Marine biology, Ocean data, etc."
            />
          </div>
